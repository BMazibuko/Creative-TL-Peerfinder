...
def download_csv():
    try:
        ...
        string_columns = [
            'id', 'name', 'phone', 'email', 'country', 'language', 'cohort', 'topic_module',
            'learning_preferences', 'availability', 'preferred_study_setup', 'kind_of_support',
            'connection_type', 'timestamp', 'group_id', 'unpair_reason', 'matched_timestamp', 'program'
        ]
...
def join_queue():
    ...
    required_fields = [name, phone, email, country, language, cohort, topic_module, learning_preferences, availability, program]
